...
?>
<a href="http://localhost/al-ijtihad/root/index.php?page=tambah-admin">Tambah Admin</a><br />
...
<?php do { ?>
        <tr>
            ...
            <td><a href="http://localhost/al-ijtihad/root/index.php?page=edit-admin&id_admin=<?php echo $row_index['id_admin']; ?>">Edit</a> | <a href="http://localhost/al-ijtihad/root/index.php?page=hapus-admin&id_admin=<?php echo $row_index['id_admin']; ?>">Hapus</a></td>
        </tr>
