            ...
            <tbody>
                ...
                while ($row_index = mysql_fetch_assoc($index)) {
                    ...
                    <tr>
                        ...
                        <td>
                            ijazah : <?php display_image_with_path_and_width($row_index['username'], '2', "../foto/", "100"); ?> 
                            SKHUN : <?php display_image_with_path_and_width($row_index['username'], '3', "../foto/", "100"); ?> 
                            <br />
                            Akta Kelahiran : <?php display_image_with_path_and_width($row_index['username'], '4', "../foto/", "100"); ?> 
                            KTP Bapak : <?php display_image_with_path_and_width($row_index['username'], '5', "../foto/", "100"); ?> 
                            <br />
                            KTP Ibu : <?php display_image_with_path_and_width($row_index['username'], '6', "../foto/", "100"); ?> 
                        </td>
