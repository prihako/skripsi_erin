...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO siswa (username, password, nama_lengkap, jenis_kelamin, agama, tempat_lahir, tanggal_lahir, nama_ortu, alamat_siswa, sekolah_asal, foto, status, tes_akademis, tes_akademis_bakat, tes_bakat, nilai_mtk, nilai_bing, nilai_bindo, nilai_ipa, nilai_ips) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
