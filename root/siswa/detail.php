...
$DetailRS1 = mysql_query($query_limit_DetailRS1, $alijtihad_db) or die(mysql_error());
...
$DetailRS2 = mysql_query($query_limit_DetailRS2, $alijtihad_db) or die(mysql_error());
